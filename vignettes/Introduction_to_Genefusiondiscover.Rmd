...
abstract: "Circulating tumor DNA (ctDNA) containing somatic mutations 
  ...
  cancer.This is an introduction to the **Genefusiondiscover** package for R,
...
Use **devtools** to install the most recent version of
**Genefusiondiscover** from the GitHub repository.

```{r setup_devtools, message=FALSE, results = 'hide', eval = FALSE}
...
```{r pull_Genefusiondiscover, message=FALSE, results = 'hide', echo = FALSE}
library(Genefusiondiscover)
library(devtools)

```

Alternatively, install **Genefusiondiscover** published at 
**Bioconductor**
...
If EML4-ALK is detected, a `data.frame` with soft-clipped reads
