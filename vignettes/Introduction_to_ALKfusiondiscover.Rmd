---
title: "ALKfusiondiscover\n \\vspace{0.5in}"
subtitle: "https://github.com/CTrierMaansson/ALKfusiondiscover\n \\vspace{0.3in}"
output: 
  html_document:
    toc: true 
    toc_depth: 3
...
abstract: | 
  ...
  This includes DNA fusions, such as the EML4-ALK, which can be an oncogenic driver in          non-small cell lung cancer.This is an introduction to the **ALKfusiondiscover** package for   R, which can be used to evaluate whether EML4-ALK is present in blood plasma. 
vignette: >
