...
output:
  html_document:
    ...
    highlight: haddock
subtitle: |-
  https://github.com/CTrierMaansson/ALKfusiondiscover
   \vspace{0.3in}
abstract: "Circulating tumor DNA (ctDNA) containing somatic mutations can be found
  ...
  to the **ALKfusiondiscover** package for   R, which can be used to evaluate whether
  EML4-ALK is present in blood plasma. \n"
vignette: |
  %\VignetteIndexEntry{Introduction to ALKfusiondiscover} %\VignetteEncoding{UTF-8} %\VignetteEngine{knitr::rmarkdown}
---
